<nav class="bg-zinc-900">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        {{-- @dump(request()->fullUrl() == url('team')) --}}
                        <x-navbar.link href="/">Dashboard</x-navbar.link>
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <x-navbar.dropdown-item href="/">Dashboard</x-navbar.dropdown-item>
            <x-navbar.dropdown-item href="/team">Team</x-navbar.dropdown-item>
